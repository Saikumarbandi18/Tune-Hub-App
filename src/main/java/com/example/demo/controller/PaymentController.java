...
public class PaymentController {
	...
	public String createOrder() {
		Order order = null;
		try {
			RazorpayClient razorpay = new RazorpayClient("rzp_test_tGYNEbLfaxcDuJ", 
					"WtJN7RZFuuRTcniTzmJSWnaM");
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
	        ...
	        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_tGYNEbLfaxcDuJ", 
	        								"WtJN7RZFuuRTcniTzmJSWnaM");
